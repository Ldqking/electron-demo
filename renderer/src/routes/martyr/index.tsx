...
const Martyr = () => {
  const [showViewImg, setShowViewImg] = useState<boolean>(false);
    ...
    <>
      ...
      <div className="app-container"
        ...
        <video
          ...
          playsInline
        >
          <source src="./img/bg/sub-bg.mp4" type="video/mp4" />
          您的浏览器不支持视频背景。
        </video>
        <div
        ...
        <div className="back" style={{display: !showViewVideo&&!showViewImg? '':'none'}} onClick={() => navigate('/')}>
          <img style={{ width: '100%', height: '100%' }} src="./back.svg" alt="back" />
        </div>
